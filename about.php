...
<body>
    ...
    <main class="container">
        ...
        <div id="softwares-windows">
            ...
            <samp>
                <div align="center">
                    My name is <b>Jam</b> the creator of this website,
                    I use these following systems.<br>
                    <strong>As far as I know</strong><br>
                    <i> Centos 7.5 (os) <br>
						 PHP 7.2.11 <br>
						 Maria DB (database) <br>
						 html <br>
						 Javascript / JQuery / Ajax <br>
						 bootstrap (css) <br>
						</i>
                    if you have question or concern you can reach me at these emails<br>
                    <a href="mailto:Admin@jamgph.com">Admin@jamgph.com</a> | <a href="mailto:jammmg26@gmail.com">jammmg26@gmail.com</a></div>
            </samp>
        </div>
    </main>
    <footer class="footer">
